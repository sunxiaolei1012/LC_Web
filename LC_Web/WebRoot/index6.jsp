...
<div class="container details_style">
	<div class="col-xs-12 col-sm-9 col-md-9 Details_Into">
		...
		<h2>网站公司tv手机客户端</h2>
		<h5 class="color3">发布作者： admin&nbsp;&nbsp;发布时间：2017-08-22&nbsp;&nbsp;浏览次数：91次</h5>
		</div>
		<div class="content mb30">
			软件名称 tv系统Android手机客户端APP正式发布。手机客户端同样支持直播和点播，开机LOGO和首页幻灯片都可做广告位。（手机客户端需额外购买）,
			外媒10月2日报道称，当地时间1日晚些时候，美国拉斯维加斯曼德勒海湾赌场外的露天音乐节发生枪击事件，造成超过50人死亡，200多人受伤。枪击事件发生后，包括携程、途牛、同程等在内的多家旅游在线机构均已启动重大自然灾害应急机制，旅游、机票、酒店、租车、客服、预订等多部门协同合作，排查当地旅客安全情况。
目前已知携程尚有6名团队游客被困封锁区，在酒店客房内避险等待救援。
相关旅游机构同时提醒在当地游客注意自身安全，尽量避免前往事发地。
	据报道，帕多克已经被击毙。NBC称，此次枪击案已经造成至少50人遇难，逾200人受伤。这是美国历史上死亡人数最多的枪击案件。
	<br>
目前，当地警方正在寻找帕多克的女伴，62岁的玛丽露·丹妮。<br>
另据CNN报道，美官员称，拉斯维加斯枪击案与美国境外恐怖主义无关。（来源：环球网）<br>
	<img src="pro/1.png" width="100%">
		</div>
	</div>
	<div class="col-xs-12 col-sm-2 col-md-2 details_operating">
		<div class="content mtb30">
			<a href="#" class="mb30">上一篇：<br>tv系统新版APK即将发布</a>
			<a href="#" class="mb30">下一篇：<br>tv系统新版APK即将发布</a>
			<a href="#" class="btn btn-danger"><i class="fa fa-th-list"></i>&nbsp;返回列表</a>
		</div>
	</div>
</div>
<!--客户选择-->
