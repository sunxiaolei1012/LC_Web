...
public class CardControl {
	 ...
	 * 根据会员卡类型ID  修改会员卡信息
	 */
	public String xiu_card(String id , String number , String ctid , String name , String phone, String address , String idcard , String price , String spend , String remain)
	{
		Card card = new Card();
