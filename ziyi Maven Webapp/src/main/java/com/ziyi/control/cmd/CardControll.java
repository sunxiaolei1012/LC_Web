...
public class CardControll {
	...
	public void openCard() {
		...
		if (b == 0) {
			System.out.println("开卡类型：" + ctid + "卡号：" + number + "会员名称：" + name + "电话：" + phone + "地址：" + address
					+ "身份证" + idcard + "开卡金额：" + price);
...
//			Card ca = Common.CARDDAO.select_card_number(oc.getNumber());
			Card ca = Common.CARDDAO.select_card_numbers(number);
			if(ca != null)
			{
...
//	public void checkCardByNnmber() throws IOException {
//
//		Card card = Common.CARDDAO.select_card_numbers(number);
//
