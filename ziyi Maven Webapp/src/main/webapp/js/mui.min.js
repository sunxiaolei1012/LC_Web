...
function(a) {
    ...
    a.openWindow = function(b, c, f) {
        ...
        if (window.plus) {
            ...
            k && j)
                ...
                j;
            if (f.createNew !== !0 && (j = plus.webview.getWebviewById(c)))
            ...
            return l.autoShow && (h = plus.nativeUI.showWaiting(l.title, l.options)),
            f = a.extend(f, {
                id: c,
                url: b
            }),
            ...
            g.autoShow && j.addEventListener("loaded", function() {
                h && h.close(),
                j.show(g.aniShow, g.duration, function() {
                    d(j),
                    e(j, "pagebeforeshow", !1)
    ...
    a.appendWebview = function(b) {
        if (window.plus) {
            var c, d = b.id || b.url;
            return a.webviews[d] || (c = plus.webview.create(b.url, d, b.styles, b.extras),
      ...
      , k = a.Class.extend({
        ...
        _initSnap: function() {
            ...
            for (var a = this.snaps, b = a.length, c = 0, d = -1, e = 0, f = 0, g = 0, h = 0, j = 0; b > j; j++) {
                ...
                k.classList.contains(i) && (this.currentPage = this.pages[c][0]),
                e >= this.maxScrollX && c++
            }
            ...
            if (this.moved) {
                ...
                "dragend" !== b.type || !c.flick) {
                    ...
                    !this.resetPosition(this.options.bounceTime)) {
                        ...
                        d != this.x || e != this.y ? ((d > 0 || d < this.maxScrollX || e > 0 || e < this.maxScrollY) && (g = j.quadratic),
        ...
        _createScrollBar: function(a) {
            ...
            d.className = f,
            b.appendChild(d),
            a === g ? (this.scrollbarY = b,
            this.scrollbarIndicatorY = d) : a === h && (this.scrollbarX = b,
                ...
                if (m) {
                    ...
                    if (n.length > 0)
                        ...
                        if (o)
                            ...
                            for (var p = c.wrapper.querySelectorAll(".mui-control-item"), g = 0, h = p.length; h > g; g++)
...
function(a, b) {
    if (a.os.plus && a.os.android) {
        ...
        a.fn.pullRefresh = function(d) {
            ...
            return h ? f = a.data[h] : (h = ++a.uuid,
            e.setAttribute("data-pullrefresh-plus-" + g, h),
            b.body.classList.add(c),
            a.data[h] = f = new k(e,d)),
    ...
    a.fn.input = function(b) {
        ...
        return this.each(function() {
            ...
            if ("range" === this.type && e.classList.contains("mui-input-range"))
                ...
                f.contains("mui-input-speech") && d.push("speech"),
