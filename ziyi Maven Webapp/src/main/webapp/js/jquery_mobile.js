(function(a, b) {
    ...
    f.support = function() {
        ...
        f(function() {
            ...
            m = c.getElementsByTagName("body")[0];
            !m || (a = c.createElement("div"),
            a.style.cssText = l + "width:0;height:0;position:static;top:0;margin-top:" + i + "px",
        ...
        removeData: function(a, b, c) {
            if (!!f.acceptData(a)) {
                ...
                if (b) {
                    d = c ? j[k] : j[k].data;
                    if (d) {
                        f.isArray(b) ? b = b : b in d ? b = [b] : (b = f.camelCase(b),
    ...
    f.event = {
        ...
        trigger: function(c, d, e, g) {
            if (!e || e.nodeType !== 3 && e.nodeType !== 8) {
                ...
                c.type = h,
                c.isDefaultPrevented() || (!p._default || p._default.apply(e.ownerDocument, d) === !1) && (h !== "click" || !f.nodeName(e, "a")) && f.acceptData(e) && o && e[h] && (h !== "focus" && h !== "blur" || c.target.offsetWidth !== 0) && !f.isWindow(e) && (n = e[o],
                n && (e[o] = null),
                f.event.triggered = h,
                e[h](),
                f.event.triggered = b,
    ...
    f.Event = function(a, b) {
        ...
        this.type = a.type,
        this.isDefaultPrevented = a.defaultPrevented || a.returnValue === !1 || a.getPreventDefault && a.getPreventDefault() ? N : M) : this.type = a,
        b && f.extend(this, b),
    ...
    f.buildFragment = function(a, b, d) {
        ...
        a.length === 1 && typeof j == "string" && j.length < 512 && i === c && j.charAt(0) === "<" && !be.test(j) && (f.support.checkClone || !bg.test(j)) && !f.support.unknownElems && bf.test(j) && (g = !0,
        h = f.fragments[j],
        h && h !== 1 && (e = h)),
    ...
    f.extend({
        ...
        style: function(a, c, d, e) {
            if (!!a && a.nodeType !== 3 && a.nodeType !== 8 && !!a.style) {
                ...
                h = typeof d,
                h === "string" && (g = bx.exec(d)) && (d = +(g[1] + 1) * +g[2] + parseFloat(f.css(a, c)),
                h = "number");
    ...
    f.extend({
        ...
        ajax: function(a, c) {
            ...
            d.crossDomain == null && (r = bT.exec(d.url.toLowerCase()),
            d.crossDomain = !(!r || r[1] == bY[1] && r[2] == bY[2] && (r[3] || (r[1] === "http:" ? 80 : 443)) == (bY[3] || (bY[1] === "http:" ? 80 : 443)))),
            ...
            if (!d.hasContent) {
                d.data && (d.url += (bO.test(d.url) ? "&" : "?") + d.data,
                delete d.data),
                k = d.url;
                if (d.cache === !1) {
                    var x = f.now()
    ...
    f.ajaxPrefilter("json jsonp", function(b, c, d) {
        ...
        if (b.dataTypes[0] === "jsonp" || b.jsonp !== !1 && (cg.test(b.url) || e && cg.test(b.data))) {
            ...
            b.jsonp !== !1 && (j = j.replace(cg, l),
            b.url === j && (e && (k = k.replace(cg, l)),
        ...
        animate: function(a, b, c, d) {
            function g() {
                ...
                for (i in a) {
                    j = new f.fx(this,b,i),
                    h = a[i],
                    cp.test(h) ? (o = f._data(this, "toggle" + i) || (h === "toggle" ? d ? "show" : "hide" : 0),
    ...
    : f.fn.offset = function(a) {
        ...
        while ((b = b.parentNode) && b !== i && b !== h) {
            ...
            b === d && (l += b.offsetTop,
            m += b.offsetLeft,
            f.support.doesNotAddBorder && (!f.support.doesAddBorderForTableAndCells || !cy.test(b.nodeName)) && (l += parseFloat(c.borderTopWidth) || 0,
...
+function(a) {
    ...
    b.prototype.backdrop = function(b) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (this.$backdrop = a('<div class="modal_backdrop ' + c + '" />').appendTo(document.body),
